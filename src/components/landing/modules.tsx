...
export function Modules() {
  return (
    <section
      id="modules"
      className="bg-ink-950 relative overflow-hidden py-20 sm:py-28"
    >
      ...
      <div className="shell relative">
        ...
        >
          {modules.map((mod) => (
            <div
              key={mod.name}
              className="group rounded-xl border border-white/10 bg-white/4 p-5 backdrop-blur-sm transition-colors duration-300 hover:border-white/25 hover:bg-white/8"
            >
        ...
        <Reveal delay={0.1}>
          <div className="mt-12 grid gap-4 rounded-2xl border border-white/10 bg-white/3 p-6 sm:grid-cols-2 lg:grid-cols-4">
